Mini Projeto Arquitetura de Sistemas

O projeto é uma aplicação full-stack que utiliza uma arquitetura MVC no backend com .NET e uma interface de usuário no frontend desenvolvida em React.

🚀 Tecnologias Utilizadas:

-.NET: Framework utilizado para o desenvolvimento do backend e da lógica de negócios.
-React: Biblioteca JavaScript para a construção da interface de usuário (frontend).
...
SDK do .NET (versão .NET 8.0)
Node.js e npm (para o frontend React)
Git (para clonar o repositório)
Editores de código (Visual Studio e VS Code)
